...
const AddRoom = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // Convert amenities object into an array
    ...
    return (
        <form onSubmit={onSubmitHandler}>
            ...
            <Title
                ...
                font="outfit"
                title="Add Room"
                subTitle="Fill in the details carefully and accurately for room details, pricing, and amenities, to enhance the user booking experience."
            />
