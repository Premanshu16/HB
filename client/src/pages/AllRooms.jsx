...
const [selectedSort, setSelectedSort] = useState('')
  ...
  // func to check if a room matches the selected room types
  ...
  // func to sort rooms based on the selected sort option
  const sortRooms = (a, b) =>{
      ...
      <div>
        <div className="flex flex-col items-start text-left">
          ...
          <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-[700px]">
            ...
            and special packages to enhance your stay
        ...
        {filteredRooms.map((room) => (
          <div
            key={room._id}
            className="flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:border-0 last:pb-30"
          >
            <img
              src={room.images[0]}
              alt="hotel"
              ...
              className="max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer hover:scale-[1.02] transition"
            />
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <p
                ...
                className="text-3xl font-playfair text-gray-800 cursor-pointer"
              >
                {room.hotel.name}
              </p>
            ...
            {/* Filters */}
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16 rounded-lg">
